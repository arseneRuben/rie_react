...
;(function($){$.fn.camera = function(opts, callback) {
	...
	var defaults = {
		...
		height				: '50.58%',	//here you can type pixels (for instance '300px'), a percentage (relative to the width of the slideshow, for instance '50%') or 'auto'		
			...
			$.each(arr, function(index, value) {
				...
				function cameraeased() {
					...
					if($('.cameraeased',target).length==blocks){
						...
						$('.cameraContent.cameracurrent',fakeHover).fadeIn(1000);
						if (lMoveInContent!=0){
